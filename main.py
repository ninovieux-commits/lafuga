...
class MenuScreen(Screen):
    ...
    def _show_story_popup(self, *a):
        """Affiche l'histoire du jeu : cadre thématique, texte CENTRÉ (H et V),
        pièces en bas, croix en haut à droite pour fermer. Pas de défilement
        ...
        col = BoxLayout(orientation="vertical",
                        padding=(WW * 0.05, WH * 0.008, WW * 0.05, WH * 0.012),
                        spacing=WH * 0.008, size_hint=(1, 1))

        # Titre
        title = Label(text="L'histoire de La Fuga", font_size=SF("20sp"),
                      bold=True, color=(0.22, 0.13, 0.05, 1),
                      size_hint=(1, None), height=WH * 0.055,
                      halign="center", valign="middle")
        title.bind(size=lambda w, s: setattr(w, "text_size", s))
        col.add_widget(title)

        # Texte : occupe l'espace, centré horizontalement ET verticalement.
        lbl = Label(text=STORY_TEXT, font_size=SF("17sp"),
                    color=(0.20, 0.12, 0.04, 1), size_hint=(1, 1),
                    halign="center", valign="middle")
        lbl.bind(size=lambda w, s: setattr(w, "text_size", s))
        col.add_widget(lbl)
        ...
        def _make_piece_cell(typ, camp):
            ...
            nm = Label(text=typ, font_size=SF("10sp"),
                       ...
                       height=WH * 0.026, halign="center", valign="middle")
        ...
        row = BoxLayout(orientation="horizontal", size_hint=(1, None),
                        height=WH * 0.085, spacing=WW * 0.01)
        ...
        # Croix (X) en haut à droite (seul moyen de fermer, pas de bouton bas)
        ...
        popup = Popup(title="", separator_height=0, title_size=SF("1sp"),
                      content=root, size_hint=(0.92, 0.82),
