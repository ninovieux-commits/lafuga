...
class AccountScreen(Screen):
    ...
    def _build(self):
        ...
        self.melo_lbl = Label(text="", font_size=SF("12sp"), bold=True,
    ...
    def on_pre_enter(self, *a):
        ...
        self.melo_lbl.text = (T("Standard : %d") % (ONLINE.melo or 1500)
                              + "\n" + T("Random : %d") % (ONLINE.melo_random or 1500))
        ...
        def on_info(info, err):
            ...
            self.melo_lbl.text = (
                T("Standard : %d") % info.get("melo", ONLINE.melo or 1500)
                + "\n" + T("Random : %d")
                % info.get("melo_random", ONLINE.melo_random or 1500))
