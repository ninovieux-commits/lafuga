...
class MenuScreen(Screen):
    ...
    def _on_random_toggle(self, *a):
        ...
        save_config(random_mode="1" if RANDOM_MODE else "0")
        self._refresh_random_btn()
...
class FugaApp(App):
    def build(self):
        ...
        # Mode Random Fuga (interrupteur global) — restauré depuis config.txt
        global RANDOM_MODE
        RANDOM_MODE = str(cfg.get("random_mode", "0")) in ("1", "True", "true")
