    ...
    def do_push(self, c, r, dc, dr):
        ...
        for cc, rr, p in reversed(line):
            ...
            if 0 <= nc < COLS and 0 <= nr < ROWS:
                ...
                if p["type"] == "Héritier":
                    loser = p["camp"]
                    # EN LIGNE : ne pas terminer tout de suite, sinon le coup de
                    # poussée (qui éjecte l'Héritier) ne serait jamais transmis à
                    # l'adversaire (il verrait l'Héritier "disparaître" sans coup).
                    # On marque le mat ; _end_turn enverra d'abord le coup en NMC,
