...
class FugaApp(App):
    ...
    def _build_real(self):
        ...
        # Le tuto ne se lance PLUS automatiquement au premier démarrage (il
        # faisait planter l'appli). Il reste accessible par le bouton Plus > Tuto.
        # (À réactiver quand le tuto sera stabilisé.)
