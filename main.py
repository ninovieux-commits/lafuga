...
THEMES = {
    ...
    "dragon": {
        ...
        # Décor de feu (rouge/orange) ; images dans themedragon/.
        "clair":     (0.85, 0.18, 0.12, 1),   # rouge dragon (bouton)
        "fonce":     (0.96, 0.60, 0.12, 1),   # orange/or (bouton)
        "clair_dim": (0.50, 0.16, 0.10, 1),
        "fonce_dim": (0.55, 0.34, 0.08, 1),
        "board":     (0.16, 0.10, 0.09, 1),   # sombre (repli si image absente)
        "menu":      (0.16, 0.10, 0.09, 1),
