...
# Icône ADAPTATIVE (Android 8+) : évite le petit logo sur fond gris.
# - foreground = le logo (idéalement avec des marges transparentes autour)
# - background = une couleur pleine qui remplit toute l'icône
icon.adaptive_foreground.filename = %(source.dir)s/icon_fg.png
icon.adaptive_background.color = #808080
